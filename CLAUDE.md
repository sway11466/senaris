...
話を勝手に広げない。オーナーからの質問には端的に答え、話を広げる必要がある場合は事前に許可を取る。
...
- [doc/gdd/chronicle.md](doc/gdd/chronicle.md) — クロニクル（出会ったユニット・陣形スキル／冒険譚ごとの戦果・物語の通し読み・設定集・記録の持ち方）
...
- [doc/campaign/ancientruins1-mine-monsters.md](doc/campaign/ancientruins1-mine-monsters.md) — 古代遺跡 第1部「鉱山の魔物」（仮・骨子）
...
- [doc/art/keyvisual.md](doc/art/keyvisual.md) — 扉絵・キービジュアルの方針（ILLUST STYLE・保管）
