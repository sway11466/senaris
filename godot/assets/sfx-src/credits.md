...
| `backstab_hit` | バックスタブの着弾（斬撃・小と同一素材） | Sonniss GDC 2026 / 344 Audio - Historical Weapons Vol. 2 `WEAPSwrd_Sword Slide Cuts, Metallic, Impact CM4 2` | wav 192kHz/24bit | 商用可・改変可・表記不要／再配布不可・AI学習不可 | `slash_s` と同一の切り出し（8.46〜9.06秒）、-1.3 dB。backstab_hit_recipe.txt |
