...
タイトルにメインテーマを置かない。作品の顔となる旋律は `menu`（キャンペーンセレクト／ステージセレクト）が担う。タイトルは酒場の扉を外から見せる画面（[../art/menu.md](../art/menu.md) §5）なので、荘厳なオーケストラより、店の中から漏れてくるざわめきのほうが場に合う。扉を開けて中に入ると `menu` が始まる、という流れで音楽が立ち上がる。
