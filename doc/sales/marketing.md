...
素材は8つの要素でできている。それぞれ別の仕事をし、同じことを重ねて言わない。

| 要素 | 何を伝えるか |
| --- | --- |
| 副題 | 名前しか見えないときのジャンル保険 |
| キービジュアル | 他のどれでもないこと（ヘックス盤＋ファンタジー） |
...
タイトル名そのものは語義を伝えない。`Senaris` は造語で、英語話者が拾えるのは `-is` 終わりのラテン語風の響き（Solaris / Polaris の系列）＝SF かファンタジーの固有名、という程度。名前の仕事は覚えられることと検索で辿り着けることの二つに限り、意味の伝達は残り7つの要素に割り振る。

### キービジュアル

一覧では横 200px 程度まで縮む。この寸法では網目は模様として残るが盤上の駒は識別できないため、盤面の縮図ではなくモチーフを大きく置く構図にする。スクリーンショット的な密度にすると縮小時にただの灰色の面になる。
