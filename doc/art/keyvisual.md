...
- ドラゴンブレスの盤の着弾は落とす絵ではなく、ヘクスの足元から立ち上がる火の壁＝横長 2:1 で、左右の端を枠で切って隣のヘクスの絵とつながる形に描く。黒背景で生成し、黒に近い色だけを透明にして③を作る（火の色には触らない）。④は③をトリムして長辺512に収める（[../gdd/skills.md](../gdd/skills.md) ドラゴンブレス）。
