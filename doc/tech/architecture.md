...
戦闘解決が「経験→包囲→支援→地形」の決定的パイプラインであり、包囲・陣形もヘックス上の空間クエリであるため、ここを純ロジックとして独立させる。これにより：
...
├─────────────────────────────────────┤
│ Domain（純ロジック / Godot非依存）    │ 戦闘解決・包囲・陣形・占領
├─────────────────────────────────────┤
│ Data（リソース定義）                 │ ユニット表・陣形レシピ・地形・テーマ
└─────────────────────────────────────┘
```
