...
The second is production. There are no factories and no build queues. Both sides start with a fixed force, and the only way to get more is to take a fort and send out the garrison holding it — reinforcements are not built, they are taken. That keeps everything on the board: more units cost you position, never money. And the unit you lost is still lost. Committing a unit is a decision, not a transaction.
