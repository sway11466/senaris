...
##
## 色は現時点の仮（ペール系の薄い色）。Terrain の種類とパスを合わせること。
...
func _initialize() -> void:
	...
	_generate("res://assets/terrain/plains.png", Color(0.80, 0.92, 0.78))   # 平地: 薄いライトグリーン
	_generate("res://assets/terrain/plateau.png", Color(0.92, 0.86, 0.72))  # 台地: ペールなベージュ
